...
vim.opt.colorcolumn = "80" -- without the ""?
...
vim.o.breakindent = true -- preserve indentation on line wrapping (width of the editor)
...
vim.o.updatetime = 250 -- frequency of certains background tasks are done, default to 4000

vim.o.timeoutlen = 300 -- time that nvim waits for a mapped key sequence to complete
...
vim.defer_fn(function()
  require("nvim-treesitter.configs").setup({
    ...
    ensure_installed = { "c", "cpp", "go", "lua", "python", "vimdoc", "vim", "bash" },
...
local on_attach = function(_, bufnr)
  ...
  nmap:help ins-completion:help ins-completion("<leader>rn", vim.lsp.buf.rename, "[R]e[n]ame")
